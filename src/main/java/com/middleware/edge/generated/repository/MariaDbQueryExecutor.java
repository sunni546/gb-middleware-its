...
public class MariaDbQueryExecutor extends QueryExecutor {
  ...
  public MariaDbQueryExecutor(@Qualifier(JdbcTemplateConfig.MARIA_DB_NAMED) NamedParameterJdbcTemplate namedJdbcTemplate) {
    super(namedJdbcTemplate);
  }

  @Override
  @SqlRetryOnFailure(retryAttempts = 1)
  @Async(EdgeDataSaveExecutorConfig.MARIADB)
